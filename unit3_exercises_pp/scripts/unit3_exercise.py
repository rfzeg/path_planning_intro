...
def dijkstra(start_index, goal_index, width, height, costmap):
  ...
  # 6. Add an empty list called 'path' to hold the path found
  # 7. Add the start node to the list of unvisited nodes
  ...
  # Search loop
  # Continue while there are still nodes in the list of unvisited nodes
  while unvisited:
